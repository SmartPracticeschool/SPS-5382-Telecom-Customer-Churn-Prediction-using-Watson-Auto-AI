...
def result():
	if request.method == 'POST':
		...
		response_scoring = requests.post('https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/a77fd05b-67a5-40d1-8ab1-17e160b261c8/predictions?version=2020-10-20', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
